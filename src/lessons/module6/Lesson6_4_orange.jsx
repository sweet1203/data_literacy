...
export default function Lesson6_4_orange() {
  return (
    <div className="space-y-6 text-slate-700 leading-relaxed">
      ...
      <InfoBox type="key">
        <strong>준비</strong>: 6-1 오렌지 실습처럼 <strong>File</strong>로 데이터를 불러 두었고, <strong>Correlation</strong>·<strong>Box Plot</strong>·<strong>Feature Statistics</strong> 중 최소 하나를 <strong>File에서 연결해 둔 상태</strong>에서 시작하세요.
      </InfoBox>
