...
export default function Lesson6_1_orange() {
  return (
    <div className="space-y-6 text-slate-700 leading-relaxed">
      ...
      <InfoBox type="key">
        <strong>준비</strong>: <strong>File</strong> 위젯으로 <code className="bg-slate-100 px-1 rounded">school_survey_200.csv</code>를 불러옵니다. 아래 위젯은 모두 <strong>File에서 선으로 연결</strong>합니다.
      </InfoBox>

      <h2 className="text-xl font-bold text-slate-800 mt-8">1단계: Correlation 위젯으로 상관계수 보기</h2>
      <ol className="list-decimal list-inside space-y-2 text-sm">
        <li>왼쪽 위젯 목록에서 <strong>Unsupervised</strong> 그룹을 펼칩니다. <strong>Correlation</strong> 위젯을 찾아 캔버스에 놓습니다.</li>
        <li><strong>File → Correlation</strong>으로 연결합니다.</li>
      ...
      <h2 className="text-xl font-bold text-slate-800 mt-8">2단계: Scatter Plot 2개</h2>
      <ol className="list-decimal list-inside space-y-2 text-sm">
        <li><strong>Scatter Plot</strong> 위젯을 두 개 캔버스에 놓습니다.</li>
        <li>각 Scatter Plot을 <strong>File</strong>에서 선으로 연결합니다. 두 위젯 모두 같은 File에 연결합니다.</li>
        <li>
      ...
      <ExerciseBlock title="확인">
        <ol className="list-decimal list-inside space-y-3 text-sm">
          ...
          <li>두 Scatter Plot에서 점 분포가 서로 비슷한가요, 다른가요? 각각 <strong>Show regression line</strong>을 클릭한 뒤 직선과 점이 잘 맞는 쪽이 어느 그래프인가요?</li>
        </ol>
      </ExerciseBlock>
