    ...
    <div className="space-y-6 text-slate-700 leading-relaxed">
      ...
      <ExerciseBlock title="과제: 오렌지3에서 아래 질문에 답하기">
        <ol className="list-decimal list-inside space-y-3 text-sm">
          ...
          <li>박스 모양이 학년마다 다르게 보이나요? (어떤 학년은 박스가 넓고, 어떤 학년은 좁다 같은 느낌) 있다면 어떻게 다른지 한 줄로 써 보세요.</li>
          <li>"평균만 보지 말고 전체 분포를 보자"는 말이, 오늘 Box Plot 보면서 어떤 점에서 와닿았나요? 한 문장으로 써 보세요.</li>
        </ol>
      </ExerciseBlock>
