  ...
  return (
    <div className="space-y-6 text-slate-700 leading-relaxed">
      ...
      <ol className="list-decimal list-inside space-y-2 text-sm">
        ...
        <li>1학년·2학년·3학년별로 박스(중앙값, 사분위)가 어떻게 다른지 비교합니다. "어느 학년의 중앙값이 가장 큰가?", "어느 학년이 가장 퍼져 있는가?"를 한번 생각해 보세요. (이 데이터에서는 박스 밖 점이 거의 없을 수 있어요.)</li>
      </ol>
      ...
      <ExerciseBlock title="생각해보기: 오렌지3에서 아래를 한번 생각해 보기">
        <ol className="list-decimal list-inside space-y-3 text-sm">
          <li>학년별 운동 일수 Box Plot에서, 박스 안 세로선(중앙값)이 가장 큰 학년이랑 가장 작은 학년이 어디인가요? 한번 생각해 보세요.</li>
          <li>박스 모양이 학년마다 다르게 보이나요? (어떤 학년은 박스가 넓고, 어떤 학년은 좁다 같은 느낌) 있다면 어떻게 다른지 한번 정리해 보세요.</li>
          <li>"평균만 보지 말고 전체 분포를 보자"는 말이, 오늘 Box Plot 보면서 어떤 점에서 와닿았나요? 한번 생각해 보세요.</li>
        </ol>
      </ExerciseBlock>
