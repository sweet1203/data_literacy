  ...
  return (
    <div className="space-y-6 text-slate-700 leading-relaxed">
      <p className="text-lg">
        ...
        <strong>Scatter Plot</strong>, <strong>Box Plot</strong>, <strong>Bar Plot</strong>을 사용해 같은 데이터를 다각도로 보세요.
      </p>

      <InfoBox type="key">
        <strong>준비</strong>: File로 <code className="bg-slate-100 px-1 rounded">school_survey_200.csv</code> 불러오기, Data Table 연결까지 완료된 상태에서 시작하세요. (시각화는 <strong>File → Scatter Plot</strong>처럼 File에서 직접 연결해도 됩니다.)
      </InfoBox>
      ...
      <ol className="list-decimal list-inside space-y-2 text-sm">
        ...
        <li><strong>Data Table → Scatter Plot</strong>으로 연결합니다. (같은 데이터라면 <strong>File → Scatter Plot</strong>으로 직접 연결해도 됩니다.)</li>
      ...
      <ol className="list-decimal list-inside space-y-2 text-sm">
        <li><strong>Box Plot</strong> 위젯을 하나 더 캔버스에 놓고 Data Table(또는 File)과 연결합니다.</li>
      ...
      <h2 className="text-xl font-bold text-slate-800 mt-8">3단계: Bar Plot으로 범주별 비교 (선택)</h2>
      <ol className="list-decimal list-inside space-y-2 text-sm">
        <li><strong>Visualize</strong>에서 <strong>Bar Plot</strong> 위젯을 놓고 Data Table(또는 File)과 연결합니다.</li>
        <li>Bar Plot에서 <strong>grade</strong>를 X축, 평균 <strong>sleep_hours</strong> 등을 Y축으로 설정해 학년별 평균을 막대로 비교해 보세요.</li>
      </ol>
      ...
      <ExerciseBlock title="확인">
        <ol className="list-decimal list-inside space-y-3 text-sm">
          ...
          <li>오늘 본 차트들에서 "이런 느낌이 들었다"를 한 줄로 정리해 보세요. (예: "학년이 올라갈수록 스마트폰 쓰는 시간이 늘어나는 것 같다.")</li>
        </ol>
      </ExerciseBlock>
