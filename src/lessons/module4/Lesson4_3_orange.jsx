    ...
    <div className="space-y-6 text-slate-700 leading-relaxed">
      ...
      <ExerciseBlock title="생각해보기: 오렌지3에서 아래를 한번 생각해 보기">
        <ol className="list-decimal list-inside space-y-3 text-sm">
          <li>산점도에서 스마트폰 사용 시간(X)과 수면 시간(Y)을 보면, 점들이 어떻게 나열돼 있나요? (폰 많이 쓸수록 잠은 적어 보이나요, 많아 보이나요, 별 관계 없나요?) 한번 생각해 보세요.</li>
          <li>학년별 스마트폰 사용 시간 Box Plot에서, 박스 안 세로선(중앙값)이 가장 큰 학년은 1, 2, 3학년 중 어디인가요? 한번 생각해 보세요.</li>
          <li>오늘 본 차트들에서 "이런 느낌이 들었다"를 한번 정리해 보세요. (예: "학년이 올라갈수록 스마트폰 쓰는 시간이 늘어나는 것 같다.")</li>
        </ol>
      </ExerciseBlock>
