...
export default function Lesson4_3_orange() {
  return (
    <div className="space-y-6 text-slate-700 leading-relaxed">
      ...
      <InfoBox type="key">
        <strong>준비</strong>: <strong>File</strong>로 <code className="bg-slate-100 px-1 rounded">school_survey_200.csv</code>를 불러옵니다. 아래 위젯은 모두 <strong>File에서 연결</strong>합니다.
      </InfoBox>
      ...
      <ol className="list-decimal list-inside space-y-2 text-sm">
        ...
        <li><strong>File → Scatter Plot</strong>으로 연결합니다.</li>
      ...
      <ol className="list-decimal list-inside space-y-2 text-sm">
        <li><strong>Box Plot</strong> 위젯을 하나 더 캔버스에 놓고 <strong>File → Box Plot</strong>으로 연결합니다.</li>
      ...
      <ol className="list-decimal list-inside space-y-2 text-sm">
        <li><strong>Visualize</strong>에서 <strong>Bar Plot</strong> 위젯을 놓고 <strong>File → Bar Plot</strong>으로 연결합니다.</li>
