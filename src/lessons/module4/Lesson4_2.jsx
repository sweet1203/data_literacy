...
export default function Lesson3_2() {
  return (
    <div className="space-y-6 text-slate-700 leading-relaxed">
      ...
      {/* 오렌지3 실습 */}
      <Link to="/lesson/4-2-orange" className="mt-8 block p-4 rounded-xl border-2 border-amber-200 bg-amber-50 hover:bg-amber-100 hover:border-amber-300 transition-colors">
