    ...
    <div className="space-y-6 text-slate-700 leading-relaxed">
      ...
      <ExerciseBlock title="생각해보기: 오렌지3에서 아래를 한번 생각해 보기">
        <ol className="list-decimal list-inside space-y-3 text-sm">
          <li>Linear Regression에서 "맞추고 싶은 값(목표)"이 뭐였고, "그걸 설명하는 변수"로 뭘 넣었나요? 한번 확인해 보세요.</li>
          <li>나온 식에서 기울기가 양수인가요, 음수인가요? 그게 "X가 커지면 Y가 커지는지, 줄어드는지"랑 어떻게 맞는지 한번 생각해 보세요.</li>
          <li>수면 8시간인 친구의 만족도를 이 모델로 예측하면 대략 몇 점쯤 나오나요? (식에 8 넣어 보거나 위젯에서 확인해 보세요.) 한번 생각해 보세요.</li>
        </ol>
      </ExerciseBlock>
